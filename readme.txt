...
Tags: contact, contact form, contact form with theme, contact form plugin,  contact form manager, contact page,  multiple contact forms, custom contact form, contact form with auto reply, contact form with recaptcha, contact form builder, contact us,  contact manager, wordpress contact
...
A quick look into Contact Form Manager :
	...
	★ Support for differnt contact form themes
...
The various form elements supported in contact form manager are listed below. If you need more fields, do checkout the [premium version](https://xyzscripts.com/wordpress-plugins/xyz-wp-contact-form/details "XYZ WP Contact Form") of this plugin.
...
= Contact Form Display =
    ...
    Supports different themes for displaying contact forms
...
Contact Form  Manager is developed and maintained by [XYZScripts](https://xyzscripts.com/ "xyzscripts.com"). For any support, you may [contact us](https://xyzscripts.com/support/ "XYZScripts Support").

★ [Contact Form Manager User Guide](http://help.xyzscripts.com/docs/contact-form-manager/ "Contact Form Manager User Guide")
★ [Contact Form Manager FAQ](http://help.xyzscripts.com/docs/contact-form-manager/faq/ "Contact Form Manager FAQ")
...
Please deactivate and reactivate the plugin. All your contact  forms should come back. If they don't, please contact our  [support desk](https://xyzscripts.com/support/ "XYZScripts Support").
...
For changing language of contact form, please check the [how-to-change-the-language-in-contact-form-manager](http://help.xyzscripts.com/docs/contact-form-manager/user-guide-free-plugin/change-the-language/ "Contact Form Manager Documentation - Changing Language") section in our docs.
...
The premium version of contact form manager can be purchased from our site [xyzscripts.com](https://xyzscripts.com/wordpress-plugins/xyz-wp-contact-form/ "XYZ WP Contact Form").

More questions ? [Drop a mail](https://xyzscripts.com/support/ "XYZScripts Support") and we shall get back to you with the answers.
...
= Contact Form Manager 1.6.2 =
* Added Contact Form to Newsletter Manager Integrity Verification Code
* Compatibility with latest version of WordPress
= Contact Form Manager 1.6.1 =
* Patch security vulnerability
* Compatibility with latest version of WordPress

= Contact Form Manager 1.6 =
* Support reCAPTCHA v2 Invisible
* Removed enqueue remote javascript
* PHP compatibility issues fixed
* WP PHPMailer library path updated
* Compatibility with wordpress 6

= Contact Form Manager 1.5 =
* Support for single column layout
* Support for contact form themes

= Contact Form Manager 1.4.6 =
* Updated captcha version
* Locale updated

= Contact Form Manager 1.4.5 =
...
= Contact Form Manager 1.4.4 =
* Security update to prevent direct access to files
* _wpnonce added
* the_editor()  changed to wp_editor()
* Data validations updated
* A few bug fixes

= Contact Form Manager 1.4.3 =
* Documentation and FAQ links updated
* Redirection issue fixed

= Contact Form Manager 1.4.2 =
* A few bug fixes
...
We would like to receive your feedback and suggestions about Contact Form Manager plugin. You may submit them at our [support desk](https://xyzscripts.com/support/ "XYZScripts Support").
