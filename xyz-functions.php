...
function xyz_cfm_links($links, $file) {
	...
	if ($file == $base) {
		...
		$links[] = '<a href="http://help.xyzscripts.com/docs/contact-form-manager/faq/"  title="FAQ">FAQ</a>';
		$links[] = '<a href="http://help.xyzscripts.com/docs/contact-form-manager/"  title="Read Me">README</a>';
