    ...
    <div style="float: left; padding: 0 5px">
        <h2 style="vertical-align: middle;">
            <a target="_blank"
                ...
                Featured XYZ WP Contact Form Premium Plugin</a>
            - Just 19 USD
        </h2>
    </div>
    <div style="float: left; margin-top: 3px">
        <a target="_blank" href="http://xyzscripts.com/members/product/purchase/XYZWPCFM"><img class="hoverImages" src="<?php  echo plugins_url("contact-form-manager/images/orange_buynow.png"); ?>">
        </a>
    </div>
    <div style="float: left; padding: 0 5px">
...
<div style="width: 100%">
    <div class="xyz_cfm_social_media">
        <h3 class="xyz_cfm_inner_head">
            Follow Us 
        </h3>
    ...
    <div class="xyz_cfm_sugession">
        <h3 class="xyz_cfm_inner_head"> Support</h3>
    ...
    <div class="xyz_cfm_new_subscribe">
        <h3 class="xyz_cfm_inner_head">
...
?>"  >
            <input class="xyz_email" name="email" type="text" placeholder="Email" value="<?php echo esc_html($current_user->user_email);?>"/>
            <input id="xyz_cfm_submit_cfm"  class="xyz_sbmt_btn" type="submit" value="Subscribe" name="Submit"  onclick="javascript: if(!verify_fields()) return false; " />
            <input type="hidden" name="listName" value="5,1,"/>
        </form>
    </div>
<div class="xyz_cfm_inmotion" >
   <a target="_blank" href="http://inmotion-hosting.evyy.net/c/1150074/260033/4222">
   <img src="<?php echo plugins_url()?>/contact-form-manager/images/xyz.png" class="xyz_inmotion_label"></a>
   </div>
</div>
<div style="clear: both;">
</div>
