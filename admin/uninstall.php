...
$wpdb->query("DROP TABLE ".$wpdb->prefix."xyz_cfm_theme_details");
...
delete_option('cfm_installed_date');
delete_option('xyz_cfm_layout_setting');
delete_option('xyz_cfm_credit_dismiss');
}
